...
export default function suite() {
  ...
  it("should support supporting interfaces", async () => {
    ...
    expect(
      await ctx.valkyriesContract.supportsInterface(ERC165InterfaceId)
    ).to.equal(true);
  });
  ...
  it("should support ERC721 Interface", async () => {
    ...
    expect(
      await ctx.valkyriesContract.supportsInterface(ERC721InterfaceId)
    ).to.equal(true);
  });
  ...
  it("should support ERC721 Metadata Interface", async () => {
    ...
    expect(
      await ctx.valkyriesContract.supportsInterface(ERC721MetadataInterfaceId)
    ).to.equal(true);
  });
  ...
  it("should support ContractURI Interface", async () => {
    ...
    expect(
      await ctx.valkyriesContract.supportsInterface(ContractURIInterfaceId)
    ).to.equal(true);
  });
  ...
  it("should support ERC2981 Interface", async () => {
    ...
    expect(
      await ctx.valkyriesContract.supportsInterface(ERC2981InterfaceId)
    ).to.equal(true);
  });
}
