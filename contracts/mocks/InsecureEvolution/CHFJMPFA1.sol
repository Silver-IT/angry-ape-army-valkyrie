...
contract CHFJMPFA1 is ERC721ABurnable, Royalty {
    // Utils
    ...
    string private _baseURI_ =
        "https://aaa-evolution-api-h5pd2zuvza-uc.a.run.app/";
    ...
    constructor(
        ...
        ERC721ABurnable("CHFJMPFA1", "CHFJMPFA1", MAX_BATCH_MINT)
    ...
    // Reserved
    function reservedMint(address to_, uint32 quantity_) public {
    ...
    // Withdrawal
    function setAaaWithdrawal(address withdrawalAddress_) public {
        require(
    ...
    function setNetvrkWithdrawal(address withdrawalAddress_) public {
        require(
            withdrawalAddress_ != address(0),
            "Set a valid withdrawal address"
        );
